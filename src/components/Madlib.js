...
const MadLib = props => <MadLibWrapper>
  ...
  <Input readOnly
    ...
    value={props.values.gender} /><br />
  <Fragment>
    <Paragraph>who has had</Paragraph>
    <Input readOnly
      defaultValue={props.values.number_of_children}
      value={props.values.number_of_children} />
    <Paragraph>children.</Paragraph><br />
  </Fragment>
  <Paragraph>I have lived in the country for</Paragraph>
  <Input readOnly
    defaultValue={props.values.years_lived_in_country}
    value={props.values.years_lived_in_country} />
  <Paragraph> years, </Paragraph><br />
  <Paragraph> and worked there for </Paragraph>
  <Input readOnly
    defaultValue={props.values.years_worked}
    value={props.values.years_worked} />
